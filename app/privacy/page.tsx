      ...
      <div className="container px-4 py-10 sm:py-14 md:py-16">
        <div className="mx-auto max-w-4xl prose prose-sm sm:prose-base md:prose-lg dark:prose-invert prose-headings:scroll-mt-24">
          ...
          <section className="mt-8">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Introduction</h2>
            <p className="text-xs sm:text-sm md:text-base">
              Atlas Technosoft (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the <Link href="/" className="text-gold hover:underline">www.atlastechnosoft.com</Link> website (the &quot;Service&quot;). This page informs you of our policies regarding the collection, use, and disclosure of Personal Information when you use our Service.
            </p>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Information Collection and Use</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Types of Data Collected</h2>
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Personal Data</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Usage Data</h3>
            <p className="text-xs sm:text-sm md:text-base">
              We may also collect information on how the Service is accessed and used (&quot;Usage Data&quot;). This Usage Data may include information such as your computer&apos;s Internet Protocol address (e.g., IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers, and other diagnostic data.
            </p>
            
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Cookies and Tracking Data</h3>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Use of Data</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Legal Basis for Processing Personal Data</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Retention of Data</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Transfer of Data</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Disclosure of Data</h2>
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Business Transaction</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Disclosure for Law Enforcement</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Legal Requirements</h3>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Security of Data</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Your Data Protection Rights</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Service Providers</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Links to Other Sites</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Children&apos;s Privacy</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">GDPR Compliance</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Data Protection Officer</h2>
            <p className="text-xs sm:text-sm md:text-base">
