    ...
    <main className="flex flex-col min-h-screen">
      ...
      <div className="container px-4 py-10 sm:py-14 md:py-16">
        <div className="mx-auto mt-6 sm:mt-8 max-w-4xl prose prose-sm sm:prose-base md:prose-lg dark:prose-invert prose-headings:scroll-mt-24">
          ...
          <section>
            <h2 className="mt-6 sm:mt-8 md:mt-10 text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Introduction</h2>
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Definitions</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">User Accounts</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Service License and Restrictions</h2>
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">License</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Restrictions</h3>
            <p className="text-xs sm:text-sm md:text-base">
              You shall not:
            </p>
            <ul className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Fees and Payment</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Intellectual Property Rights</h2>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Feedback</h3>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Data Processing and Security</h2>
            <p className="text-xs sm:text-sm md:text-base">
              Our processing of personal data is governed by our <Link href="/privacy" className="text-gold hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference.
            </p>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Confidentiality</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Warranties and Disclaimers</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Limitation of Liability</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Indemnification</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Term and Termination</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Governing Law and Jurisdiction</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Dispute Resolution</h2>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Miscellaneous</h2>
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Entire Agreement</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Waiver</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Severability</h3>
            <p className="text-xs sm:text-sm md:text-base">
              If any provision of these Terms is held by a court or other tribunal of competent jurisdiction to be invalid, illegal, or unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent such that the remaining provisions of these Terms will continue in full force and effect.
            </p>
            
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Assignment</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Force Majeure</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">No Third-Party Beneficiaries</h3>
            <p className="text-xs sm:text-sm md:text-base">
            ...
            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-gold">Notices</h3>
            <p className="text-xs sm:text-sm md:text-base">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary">Contact Us</h2>
            <p className="text-xs sm:text-sm md:text-base">
              If you have any questions about these Terms, please contact us at:
            </p>
            <div className="mt-3 sm:mt-4 p-3 sm:p-4 border rounded bg-primary/30 text-xs sm:text-sm md:text-base">
              <div className="flex flex-col sm:flex-row sm:gap-4">
                ...
                <div className="mt-3 sm:mt-0 sm:flex-1">
                  <p className="mt-1 sm:mt-2">Email: <Link href="mailto:info@atlastechnosoft.com" className="text-gold hover:underline break-words">info@atlastechnosoft.com</Link></p>
                  <p>Phone: <Link href="tel:+912222401925" className="text-gold hover:underline">+91-22-2240 1925</Link></p>
                </div>
              </div>
            </div>
          </section>
          
          <div className="mt-10 mb-6 bg-primary text-primary-foreground rounded-lg p-6 sm:p-8">
            ...
            <a 
              href="/contact" 
              className="inline-flex h-10 items-center justify-center rounded-md bg-gold px-6 text-sm font-medium text-primary shadow transition-colors hover:bg-gold/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
            >
