  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-accent/10 blur-[100px] animate-pulse-slow"
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex items-center justify-center">
            <div className="relative">
              ...
              <div
                className="absolute -bottom-6 -right-6 h-12 w-12 rounded-full bg-accent/10 animate-pulse-slow"
                style={{ animationDelay: "1s" }}
              ></div>
