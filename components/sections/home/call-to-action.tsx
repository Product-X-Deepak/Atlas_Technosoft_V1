  ...
  return (
    <section ref={ref} className="py-16">
      <div className="container px-4 md:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-amber-600/30 bg-white px-4 py-2 text-sm font-medium text-orange-500">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Button 
              size="lg" 
              className="bg-[#E84A0E] text-white hover:bg-[#E84A0E]/90 px-6" 
              asChild
            >
              <Link href="/contact" className="flex items-center">
                Contact Sales
