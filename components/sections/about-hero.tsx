      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          >
            ...
            >
              Founded in 1997, Atlas Technosoft is a leading SAP Partner providing ERP consulting, IT hardware, software solutions, and enterprise applications since 1997. With over 28 years of experience, we&apos;ve helped transform over 750 businesses across the globe.
            </motion.p>
