        ...
        <div className="grid grid-cols-1 gap-y-6 xs:gap-y-8 sm:gap-y-10 md:grid-cols-12 md:gap-x-4 lg:gap-x-6 xl:gap-x-8 md:gap-y-8 lg:gap-y-10">
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6 md:col-span-12 lg:col-span-3">
            ...
            <p className="text-xs xs:text-sm text-gray-300 max-w-xs">
              Leading SAP Partner providing cutting-edge ERP solutions and AI-powered automation since 1997.
            </p>
          ...
          <div className="md:col-span-12 lg:col-span-6 grid grid-cols-1 xs:grid-cols-2 gap-y-6 xs:gap-y-7 sm:gap-y-8 gap-x-3 xs:gap-x-4 sm:gap-x-6 lg:gap-x-8">
            ...
            <div className="space-y-5 xs:space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 xs:space-y-3 sm:space-y-4">
                <h3 className="text-xs xs:text-sm sm:text-base font-medium text-orange-500 border-b border-primary/30 pb-1.5 xs:pb-2 mb-1.5 xs:mb-2 sm:mb-3">
            ...
            <div className="space-y-5 xs:space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 xs:space-y-3 sm:space-y-4">
                <h3 className="text-xs xs:text-sm sm:text-base font-medium text-orange-500 border-b border-primary/30 pb-1.5 xs:pb-2 mb-1.5 xs:mb-2 sm:mb-3">
                  <span className="text-orange-500">Automation Solutions</span>
                </h3>
                <ul className="space-y-0 xs:space-y-1 sm:space-y-2">
                  <li>
                    <Link
              ...
              <div className="space-y-2 xs:space-y-3 sm:space-y-4">
                <h3 className="text-xs xs:text-sm sm:text-base font-medium text-orange-500 border-b border-primary/30 pb-1.5 xs:pb-2 mb-1.5 xs:mb-2 sm:mb-3">
                  <span className="text-orange-500">Quick Links</span>
                </h3>
                <ul className="space-y-0 xs:space-y-1 sm:space-y-2">
                  <li>
                    <Link
          ...
          <div className="space-y-2 xs:space-y-3 sm:space-y-4 md:col-span-12 lg:col-span-3">
            ...
            <ul className="space-y-2 xs:space-y-3 sm:space-y-4">
              <li>
                ...
                >
                  <Mail size={12} className="mr-1.5 xs:mr-2 sm:mr-3 mt-0.5 flex-shrink-0 text-orange-500 group-hover:text-orange-500 transition-colors duration-200 xs:w-[14px] xs:h-[14px] sm:w-4 sm:h-4" />
              ...
              <li>
                <Link
                  ...
                  className="flex items-start text-[10px] xs:text-xs sm:text-sm text-gray-300 hover:text-primary transition-colors duration-200 group py-1.5 xs:py-2 min-h-[40px] xs:min-h-[44px] touch-target-improved"
                >
                  <Phone size={12} className="mr-1.5 xs:mr-2 sm:mr-3 mt-0.5 flex-shrink-0 text-orange-500 group-hover:text-orange-500 transition-colors duration-200 xs:w-[14px] xs:h-[14px] sm:w-4 sm:h-4" />
              ...
              <li className="flex items-start text-[10px] xs:text-xs sm:text-sm text-gray-300 group py-1.5 xs:py-2 min-h-[40px] xs:min-h-[44px]">
                <MapPin size={12} className="mr-1.5 xs:mr-2 sm:mr-3 mt-0.5 flex-shrink-0 text-orange-500 group-hover:text-orange-500 transition-colors duration-200 xs:w-[14px] xs:h-[14px] sm:w-4 sm:h-4" />
              ...
              <li className="flex items-start text-[10px] xs:text-xs sm:text-sm text-gray-300 group py-1.5 xs:py-2 min-h-[40px] xs:min-h-[44px]">
                <Clock size={12} className="mr-1.5 xs:mr-2 sm:mr-3 mt-0.5 flex-shrink-0 text-orange-500 group-hover:text-orange-500 transition-colors duration-200 xs:w-[14px] xs:h-[14px] sm:w-4 sm:h-4" />
                <div>
