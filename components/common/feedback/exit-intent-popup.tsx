        ...
        >
          ...
          >
            <Card className="relative overflow-hidden border-primary/20 bg-background/80 backdrop-blur-md">
              ...
              <CardHeader>
                <CardTitle className="text-center text-2xl text-white">Before You Go...</CardTitle>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <Input
                    ...
                    className="h-11 futuristic-input text-white"
                    disabled={isLoading}
                  />
                  <Button type="submit" className="w-full bg-[#E84A0E] text-white hover:bg-[#E84A0E]/90" disabled={isLoading}>
                    {isLoading ? (
                      <>
              ...
              <CardFooter className="flex flex-col space-y-2 text-center text-sm text-muted-foreground">
                <p className="text-white">We respect your privacy and will never share your information.</p>
                <p>
                  Already a subscriber?{" "}
                  <Link href="/contact" className="text-orange-500 hover:underline" onClick={handleClose}>
                    Contact us
                  </Link>
                </p>
              </CardFooter>
